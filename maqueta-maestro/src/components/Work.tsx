      ...
      <div className="mx-auto max-w-[1400px] px-6">
            ...
            >
              ...
              >
                <div className="p-6">
                  ...
                  <h3 className="mb-3 mt-2 text-xl font-semibold text-zinc-900 dark:text-white">
                    {project.title}
                  </h3>
        ...
        >
          <div className="mb-16 text-center">
            ...
            <p className="mx-auto max-w-2xl text-zinc-600 dark:text-white">
        ...
        <div className="relative mb-32 min-h-[600px]">
        ...
        <div className="mt-32">
          ...
          >
            <div className="flex h-full w-full flex-col items-center gap-8 rounded-2xl bg-zinc-100 p-8 md:flex-row">
              <div className="w-full md:w-1/2">
                <h3 className="mb-6 text-2xl font-bold text-zinc-900 md:text-3xl">
                  WordPress en Buenas Manos
                </h3>
                <p className="mb-8 text-zinc-600">¿Por qué elegir elegirme?</p>
                ...
                >
                  ...
                  >
                    <AccordionItem value="item-1" className="border-none">
                      <AccordionTrigger className="rounded-xl bg-zinc-200 p-6 transition-colors hover:bg-zinc-300 dark:bg-[#27272A] dark:hover:bg-[#323232]">
                        <h4 className="text-lg font-semibold text-zinc-900 dark:text-[#c5fb00]">
                          Relaciones a Largo Plazo
                        </h4>
                      </AccordionTrigger>
                      <AccordionContent className="mt-1 rounded-xl bg-zinc-200 px-6 pb-6 dark:bg-[#27272A]">
