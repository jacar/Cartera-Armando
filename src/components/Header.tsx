        ...
        <>
          ...
          <LazyMotion features={domAnimation}>
            <motion.div
              ...
              className="fixed left-0 top-0 z-50 h-full w-[280px] overflow-y-auto border-r border-zinc-200 bg-zinc-100 dark:border-zinc-800 dark:bg-black lg:hidden mobile-nav"
            >
            ...
            <nav className="flex flex-col p-4">
              ...
              <LazyMotion features={domAnimation}>
                ...
                <div className="flex flex-wrap items-center justify-center gap-6 mx-4 mt-4">
